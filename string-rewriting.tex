...
\footnote[][-2.25\baselineskip]{Strings are isomorphic to the finite words used by automata~\parencref{ch:automata}, but the two serve different conceptual roles in this dissertation.}
...
\fixnote{Replace $\octx$ with $w$ or $c$?}
...
\begin{align*}
  w &\Coloneqq e \mid w \oc b_0 \mid w \oc b_1 \mid w \oc i \\
  \lctx &\Coloneqq w \oc d \mid \lctx \oc b'_0 \mid z \mid w \oc s
\end{align*}
\begin{equation*}
  \begin{lgathered}
