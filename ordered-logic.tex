...
\begin{marginfigure}[-4.65\baselineskip]
  \begin{gather*}
...
The persistent resouce $p \limp A$ that derives from $\bang (p \limp A)$ can be copied \emph{anywhere} into the ordered context.
