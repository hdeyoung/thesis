...
Together, cut and identity elimination \lcnamecrefs{thm:ordered-logic:cut-elimination}~\parencref{thm:ordered-logic:cut-elimination,thm:ordered-logic:id-elimination} serve to establish a proof normalization result: every proof has a corresponding verification.
