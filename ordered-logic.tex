...
\paragraph{Contexts}
To keep the notation for sequents concise, the list of antecedents is usually packaged into an ordered context $\octx = A_1 \oc A_2 \dotsb A_n$, with the sequent then written $\oseq{\octx |- A}$.\footnote{We will also sometimes use $\lctx$ as an additional metavariable for ordered contexts.}
