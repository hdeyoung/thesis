...
Following the vast literature on various forms of bisimilarity%
\footnote{See \textcite{??} for a survey.}%
, this \lcnamecref{ch:ordered-bisimilarity} therefore develops a notion of \emph{ordered rewriting bisimilarity} in which atoms are observable and [...].
...
\newthought{\Cref{sec:ordered-bisimilarity:??} begins} by defining rewriting bisimilarity (along with a few auxiliary notions) and then presents a few examples of contexts that are \emph{not} bisimilar under this definition.
