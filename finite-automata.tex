...
In later \lcnamecrefs{ch:ordered-bisimilarity}, we will refer to a notion of bisimilarity for \acp{NFA} that was originally developed by \textfootcite{Milner:??}.
