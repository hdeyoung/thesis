\chapter{Preliminaries: Binary relations and automata}\label{ch:automata}\label{ch:finite-automata}
...
The following definition is adapted from \textcite{Beal+Carton:TCS02}.
\begin{definition}
