...
%
\begin{proof}
  Because bisimilarity is [...]\fixnote{Not symmetric, but ...}~\parencref{thm:nfa-bisim-sym}, it suffices to show that $q \asim s$ implies $\autlang{\aut{A}_1}{q} \subseteq \autlang{\aut{A}_2}{s}$.
