...
Also, the mapping $\embed*{}$ relies on the $\bigfuse$ operation -- $\bigfuse \embed{A}$ inserts a $\dn$ shift in front of $\embed{A}$ exactly when $\embed{A}$ and hence $A$ are nonatomic.
