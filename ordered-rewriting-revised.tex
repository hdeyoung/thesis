...
\subsection{An ordered rewriting framework}
...
\subsection{Properties of the ordered rewriting framework}
...
It is even possible to embed the unfocused ordered rewriting framework of \cref{sec:??} and a weakly focused ordered rewriting framework within focused ordered rewriting in an operationally faithful way, as we now show.
