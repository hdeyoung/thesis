...
We require that recursive type definitions be \emph{contractive}\autocite{Gay+Hole:AI05} -- that the body of each recursive type definition begin with a type constructor ($\plus$ or $\with$) at the top level.
